...
// UpdateN2IHxzDeployment 测试从 nodeport 模式更新为 ingress 模式
func UpdateN2IHxzDeployment(ctx *framework.TestContext, f *framework.Framework) {
	var (
		// 1. 准备测试数据
	...
	Context("Update hxzdeployment mod nodeport to ingress", func() {
	...
	Context("Delete hxzdeployment n2i", func() {
